          ...
          {!sent ? (
            <>
              ...
              <p className="text-center text-sm text-slate-500 mt-8">
                <a
                  href="/login"
                  className="inline-flex items-center gap-1 text-heal-500 hover:text-heal-600 font-semibold"
                >
